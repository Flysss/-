...
#define kMainPageScale     1.0 //打开左侧窗时，中视图（右视图）缩放比列
...
#define vCouldChangeDeckStateDistance  (kScreenWidth - kMainPageDistance)/2.0 - 40 //滑动距离大于此数时，状态改变（关－－》开，或则开－－》关）
#define vSpeedFloat   0.7   //滑动速度


#define kLeftAlpha    0.9 //左侧蒙板的最大值
#define kLeftCenterX  30  //左侧起始偏移量
#define kLeftScale    0.7 //左侧初始缩放比列

#define vDeckCanNotPanViewTag 987654 //不响应此侧滑的View的tag


#import <UIKit/UIKit.h>
#import "UIView+UIView_extra.h"



@interface LeftSlideViewController : UIViewController
//滑动速度系数建议在0.5-1之间。默认为0.5
